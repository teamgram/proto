...
func (c *rPCAuthKeyClient) ReqPq(ctx context.Context, in *TLReqPq, opts ...grpc.CallOption) (*ResPQ, error) {
	...
	out := new(ResPQ)
	err := c.cc.Invoke(ctx, RPCAuthKey_ReqPq_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCAuthKeyClient) ReqPqMulti(ctx context.Context, in *TLReqPqMulti, opts ...grpc.CallOption) (*ResPQ, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResPQ)
	err := c.cc.Invoke(ctx, RPCAuthKey_ReqPqMulti_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCAuthKeyClient) Req_DHParams(ctx context.Context, in *TLReq_DHParams, opts ...grpc.CallOption) (*Server_DH_Params, error) {
	...
	err := c.cc.Invoke(ctx, RPCAuthKey_Req_DHParams_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCAuthKeyClient) SetClient_DHParams(ctx context.Context, in *TLSetClient_DHParams, opts ...grpc.CallOption) (*SetClient_DHParamsAnswer, error) {
	...
	err := c.cc.Invoke(ctx, RPCAuthKey_SetClient_DHParams_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCAuthKeyClient) DestroyAuthKey(ctx context.Context, in *TLDestroyAuthKey, opts ...grpc.CallOption) (*DestroyAuthKeyRes, error) {
	...
	err := c.cc.Invoke(ctx, RPCAuthKey_DestroyAuthKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRPCAuthKeyServer should be embedded to have
...
func (UnimplementedRPCAuthKeyServer) testEmbeddedByValue() {}
...
func RegisterRPCAuthKeyServer(s grpc.ServiceRegistrar, srv RPCAuthKeyServer) {
	// If the following call pancis, it indicates UnimplementedRPCAuthKeyServer was
